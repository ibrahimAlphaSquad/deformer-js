...
const originalPayloadRain = noiseUtil.decode(noisyPayloadRain);
console.log("Decoded Rain payload:", originalPayloadRain);

const noisyPayloadTip = {
  _v: "1.0",
  _t: 1734614571089,
  _s: "7286bc529aaf8e44196972cc00dd6319",
  _i: "9598bd7cad5e06bf0758e5d7fdef8e05",
...
// Decode on receiver side
const originalPayloadTip = noiseUtil.decode(noisyPayloadTip);
console.log("\n\nDecoded Tip payload:", originalPayloadTip);
